...
exports.BoxUploadModule = void 0;
const common_1 = require("@nestjs/common");
const box_controller_1 = require("./box.controller");
const box_service_1 = require("./box.service");
let BoxUploadModule = class BoxUploadModule {
};
exports.BoxUploadModule = BoxUploadModule;
exports.BoxUploadModule = BoxUploadModule = __decorate([
    (0, common_1.Module)({
        imports: [],
